              ...
              <div className="p-5 border-b border-[var(--border-color)] flex-shrink-0">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${deviceFilter === 'all'
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${deviceFilter === 'with_device'
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${deviceFilter === 'without_device'
            ...
            <div className="space-y-3">
              {stats?.recentDisasters?.slice(0, 5).map((disaster: any, idx: number) => (
                <div key={idx} className="flex items-center gap-3 p-3 rounded-lg hover:bg-[var(--bg-input)] transition-colors">
                  <div className={`w-2 h-2 rounded-full ${disaster.severity === 'critical' ? 'bg-red-500' :
