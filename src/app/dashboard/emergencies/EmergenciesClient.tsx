...
interface EmergenciesClientProps {
  initialEmergencies: Emergency[];
}

export default function EmergenciesClient({ initialEmergencies }: EmergenciesClientProps) {
  ...
  // Fetch emergencies when search or filters change (debounced)
  useEffect(() => {
    if (token) {
