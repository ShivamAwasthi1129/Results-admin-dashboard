...
import {
  ...
  TrashIcon, EyeIcon, GlobeAltIcon, ArchiveBoxIcon, DocumentDuplicateIcon,
  ChartBarIcon, RectangleStackIcon, HeartIcon, CalendarIcon, MapPinIcon,
  CurrencyDollarIcon, CheckCircleIcon, ClockIcon, XCircleIcon,
  ArrowTopRightOnSquareIcon, SparklesIcon, Squares2X2Icon,
  Bars3Icon, ArrowPathIcon, TagIcon, UsersIcon, PhotoIcon,
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {campaigns.map(campaign => {
              ...
              const progress = campaign.goalAmount && campaign.raisedAmount ? Math.min(100, (campaign.raisedAmount / campaign.goalAmount) * 100) : 0;
                ...
                >
                  ...
                  <div className="px-5 py-3.5 border-t border-theme bg-theme-secondary flex items-center justify-between gap-2">
                    <div className="flex items-center gap-2">
                      ...
                      <a
                        href={`http://localhost:3000/campaigns/${campaign.slug}`}
                        target="_blank"
                        rel="noreferrer"
