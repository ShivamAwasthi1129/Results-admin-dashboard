...
user_mgmt_cases = [
    ["WA201", "User Management", "User List", "View all users from external API", "1. Login as admin/super_admin\n2. Navigate to User Management page from sidebar\n3. Wait for data to load", "API: https://r3sults-backend.vercel.app/api/admin/users", "All users should be displayed in a table format with columns: User Info, Contact Details, Location, Role & Status, Account Details, Groups, Actions. Data should be fetched from external API.", "", "Pass/Fail/Blocked", "High", "", ""],
    ...
    ["WA243", "User Management", "API Integration", "Fetch users from external API", "1. Navigate to User Management page\n2. Check network tab", "API: https://r3sults-backend.vercel.app/api/admin/users", "API should be called successfully. Response should contain users array and pagination object. Data should be displayed correctly.", "", "Pass/Fail/Blocked", "Critical", "", ""],
